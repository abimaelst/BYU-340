...
--Create relationship between `account` and `message` tables for message TO

ALTER TABLE IF EXISTS public.message
	ADD CONSTRAINT fk_message_to FOREIGN KEY (message_to)
	REFERENCES public.account (account_id) MATCH SIMPLE
	ON UPDATE CASCADE
	ON DELETE NO ACTION;


--Create relationship between `account` and `message` tables for message FROM

ALTER TABLE IF EXISTS public.message
	ADD CONSTRAINT fk_message_from FOREIGN KEY (message_from)
	REFERENCES public.account (account_id) MATCH SIMPLE
	ON UPDATE CASCADE
	ON DELETE NO ACTION;
...
CREATE TABLE public.reviews (
  ...
  CONSTRAINT fk_inventory FOREIGN KEY (inv_id) REFERENCES public.inventory(inv_id) ON UPDATE CASCADE ON DELETE CASCADE,
